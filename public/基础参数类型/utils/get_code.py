...
def reback():
    ...
    content = '{"platformId":"ALIYUN01","magicId":"2002"}'
    sign = sha1_encrypt("bizCode=DUB00114&bizId=12&content=%s&timestamp=%s&appKey=%s" % (
        content, current_time, app_secret))
    print(f"SHA1 Encrypted gModel: {sign}")
    payload = {"appId": "ZDOCR001", "bizCode": "DUB00114", "bizId": "12",
...
if __name__ == '__main__':
    with open('/Users/1k/code/YiBao/jyk/基础参数类型/4_国家_2002.json', 'w', encoding='utf-8') as f:
            json.dump(reback(), f, ensure_ascii=False, indent=2)